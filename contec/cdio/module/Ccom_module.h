...
// Resource type
//================================================================
#define SRC_TYPE_UNUSED		1
#define SRC_TYPE_PORTIO		2
#define SRC_TYPE_MEMIO		3
//================================================================
// Device type
//================================================================
...
#define	DEVICE_TYPE_DEMO			6		// DEMO (DIO-CPS-BXC200)
...
typedef struct {
	...
	int						(*init_resource_type)(void *);				// Entry for init_resource_type
