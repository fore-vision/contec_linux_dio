...
// Recognized device information acquisition function
typedef struct {
	short			type;						// Information type
	unsigned long	param1;						// Parameter1
	unsigned long	param2;						// Parameter2
	unsigned long	param3;						// Parameter3
	long			ret;						// Return value
} CDIO_GET_CUR_INFO, *PCDIO_GET_CUR_INFO;

//================================================================
// Recognized device information type
//================================================================
#define	IDIO_CUR_ROM_REVISION		0		// ROM revision (unsigned char)
#define	IDIO_CUR_BOARD_REVISION		1		// Board revision (unsigned char)
...
#define	CDIO_IOC_GET_CUR_DEV_INFO	_IOWR(CDIO_IOC_MAGIC, 15, PCDIO_GET_CUR_INFO)						// Recognized device information acquisition function
